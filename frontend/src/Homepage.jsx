  ...
  return (
    <div className="bg-gradient-to-b from-white to-[#FFF9DB] min-h-screen flex flex-col">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/veg.jpg')" }}
      >
        <div className="backdrop-blur-md bg-white/30 p-10 rounded-lg shadow-xl">
          ...
          <div className="flex gap-4">
            <a href="#register-user" className="bg-[#0D1B2A] hover:bg-[#1a2e4a] text-white px-6 py-3 rounded-md transition">Register as User</a>
            <a href="#register-nonuser" className="bg-[#0D1B2A] hover:bg-[#1a2e4a] text-white px-6 py-3 rounded-md transition">Register as Non-User</a>
          </div>
        </div>
      </section>
      ...
      <section id="who-can-join" className="py-16 px-6 text-center bg-[#0D1B2A] text-white">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          ...
          {/* Non-User Card */}
          <div className="relative w-full md:w-1/3 p-8 rounded-lg bg-white/10 backdrop-blur-md shadow-lg transform hover:scale-105 transition border-2 border-white">
            <h3 className="text-2xl font-semibold mb-4">Non-User (Donor/Helper)</h3>
      ...
      <section id="how-it-works" className="py-16 px-6 flex justify-center bg-[#0D1B2A] text-white">
        <div className="backdrop-blur-lg bg-white/10 p-10 rounded-xl max-w-4xl text-center shadow-md">
          ...
          <ul className="space-y-6 text-lg">
            <li>1. Register as User or Non-User</li>
      ...
      <section id="register" className="py-16 text-center px-6">
        ...
        <div className="flex gap-4 justify-center">
          <a href="#register-user" className="bg-[#0D1B2A] hover:bg-[#1a2e4a] text-white px-6 py-3 rounded-md transition">Join as Food Seeker</a>
          <a href="#register-nonuser" className="bg-[#0D1B2A] hover:bg-[#1a2e4a] text-white px-6 py-3 rounded-md transition">Become a Food Donor</a>
        </div>
      </section>
      ...
      <footer className="bg-[#0D1B2A] text-white py-6 text-center mt-auto">
        <div className="flex justify-center gap-6 mb-2">
          ...
          <a href="#browse" className="hover:underline">Browse Food</a>
